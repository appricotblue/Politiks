...
const Inbox = () => {
  ...
  const itemData = [
    { id: 1, name: 'Alex Linderson', followers: 'How are you today?', image: images.ViratBanner },
    { id: 2, name: 'Jacob Jones', followers: 'How are you today?', image: images.Welcome_1 },
    { id: 3, name: 'Item Name 3', followers: ' Hello?', image: images.Welcome_2 },
    { id: 4, name: 'Item Name 2', followers: 'Are you There? ', image: images.Welcome_1 },
  ...
  const renderItem = ({ item }) => (
    <TouchableOpacity style={styles.itemContainer}>
      <View style={{ width: getWidth(8), }}>
        ...
        <View style={{ width: 10, height: 10, backgroundColor: '#0FE16D', borderRadius: 10, position: 'absolute', bottom: 10, right: 1 }}></View>
      </View>
      ...
      <View style={{ width: getWidth(6), justifyContent: 'center', alignItems: 'center' }}>
        <Text>3 min</Text>
        <View style={{ width: 30, height: 30, borderRadius: 30, backgroundColor: 'red', justifyContent: 'center', alignItems: 'center' }}><Text style={{ color: 'white' }}>4</Text></View>
      </View>
    </TouchableOpacity>
  );
  return (
