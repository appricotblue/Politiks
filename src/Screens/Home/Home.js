...
const Home = props => {
  ...
  const data = [
    ...
    { id: '3', title: 'Item 3', imageUrl: images.Welcome_1 },
  ...
  const verticalListData = [
    { id: '1', name: 'Virat Kohli', type: 'image', media: 'https://www.whitehouse.gov/wp-content/uploads/2021/01/Joe-Biden-3.jpg', designation: 'Bangalore', description: 'Stumptown brunch raw umami flannel dollar pour-over ipsum. Booth glossier squid craft kale.😍❤️❤️', image: images.ViratProfile },
